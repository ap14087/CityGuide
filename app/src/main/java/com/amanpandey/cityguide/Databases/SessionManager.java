package com.amanpandey.cityguide.Databases;
...
public class SessionManager {
    ...
    //Session names making it public so that user can pass it from other activity also
    ...
    */
    ...
    //get all the fields for which user wants to store the data
    public void createLoginSession(String fullName, String username, String email, String phoneNo, String password, String age, String gender) {
        ...
        //changing values of the strings using editor
        editor.putBoolean(IS_LOGIN, true);

        //setting values of keys by the strings we are getting from function
